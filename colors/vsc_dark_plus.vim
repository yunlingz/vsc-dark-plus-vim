...
" ---------------------------------------------------------------------
let g:colors_name = "vsc_dark_plus"
set background=dark
" ---------------------------------------------------------------------
...
call s:HL('IncSearch', s:colors.background, s:colors.gray)
call s:HL('LineNr', s:colors.line_nr, s:colors.none)
...
call s:HL('Search', s:colors.background, s:colors.yellow)
...
call s:HL('Visual', s:colors.none, s:colors.selection_bg)
call s:HL('VisualNOS', s:colors.none, s:colors.selection_bg)
call s:HL('WarningMsg', s:colors.red, s:colors.none)
call s:HL('WildMenu', s:colors.background, s:colors.cyan)

" standard syntax
" ----------------------------------------------------
call s:HL('Comment', s:colors.comment, s:colors.none)
" ----------------------------------------------------
call s:HL('Constant', s:colors.const, s:colors.none)
call s:HL('String', s:colors.red, s:colors.none)
call s:HL('Character', s:colors.red, s:colors.none)
call s:HL('Number', s:colors.num, s:colors.none)
call s:HL('Boolean', s:colors.blue, s:colors.none)
call s:HL('Float', s:colors.num, s:colors.none)
" ----------------------------------------------------
call s:HL('Identifier', s:colors.cyan, s:colors.none)
call s:HL('Function', s:colors.yellow, s:colors.none)
" ----------------------------------------------------
call s:HL('Statement', s:colors.magenta, s:colors.none, s:colors.bold)
call s:HL('Conditional', s:colors.magenta, s:colors.none, s:colors.bold)
call s:HL('Repeat', s:colors.magenta, s:colors.none, s:colors.bold)
call s:HL('Operator', s:colors.foreground, s:colors.none)
call s:HL('Keyword', s:colors.blue, s:colors.none, s:colors.bold)
call s:HL('Exception', s:colors.magenta, s:colors.none, s:colors.bold)
" ----------------------------------------------------
...
call s:HL('Structure', s:colors.blue, s:colors.none, s:colors.bold)
call s:HL('Typedef', s:colors.blue, s:colors.none, s:colors.bold)
" ----------------------------------------------------
call s:HL('Special', s:colors.special, s:colors.none)
" ----------------------------------------------------
call s:HL('Underlined', s:colors.none, s:colors.none, s:colors.underline)
call s:HL('Ignore', s:colors.none, s:colors.none)
call s:HL('Error', s:colors.red, s:colors.none, s:colors.bold)
call s:HL('Todo', s:colors.background, s:colors.num)
